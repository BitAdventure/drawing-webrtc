...
export class WebRTCService {
  ...
  private iceTimeouts: { [key: string]: number };
  ...
  constructor(
    ...
    iceTimeoutsRef: React.RefObject<{ [key: string]: number }>,
  ...
  public createPeer(
    ...
    peer.onicecandidate = async (event) => {
      ...
      event.candidate && this.relay(peerId, "ice-candidate", event.candidate);
    };
  ...
  public async handleSessionDescription(
    ...
    try {
      ...
      if (remoteDescription.type === "offer") {
        ...
        await this.relay(peerId, "session-description", answer);
      }
    } catch (error) {
